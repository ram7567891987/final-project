/* Demo purposes only */
  ...
  // Получаем элементы
const titleBlog = document.querySelector('.titleBlog', '.btmTextBlog', 'titleTextSection', 'btmTextSection');
...
// Наблюдаем за элементом .titleBlog
observer.observe(titleBlog);
